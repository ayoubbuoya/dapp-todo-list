...
let ToDoList = (_dec = NearBindgen({}), _dec2 = initialize(), _dec3 = view(), _dec4 = call({}), _dec5 = call({}), _dec(_class = (_class2 = class ToDoList {
  tasks = [];
  init({
    tasks
  }) {
  ...
  get_tasks() {
    log(`Getting tasks ${JSON.stringify(this.tasks)}`);
    return this.tasks;
  }
  add_task({
    id,
...
}, (_applyDecoratedDescriptor(_class2.prototype, "init", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "init"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_tasks", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "get_tasks"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "add_task", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "add_task"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "delete_task", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "delete_task"), _class2.prototype)), _class2)) || _class);
function delete_task() {
  const _state = ToDoList._getState();
  if (!_state && ToDoList._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  const _contract = ToDoList._create();
  if (_state) {
    ToDoList._reconstruct(_contract, _state);
  }
  const _args = ToDoList._getArgs();
  const _result = _contract.delete_task(_args);
  ToDoList._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(ToDoList._serialize(_result, true));
}
function add_task() {
  const _state = ToDoList._getState();
  if (!_state && ToDoList._requireInit()) {
...
export { add_task, delete_task, get_tasks, init };
